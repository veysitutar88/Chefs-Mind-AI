...
export const chatSessions = pgTable(
  ...
  table => ({
    ...
    userIdAgentTypeIdx: index('chat_sessions_user_id_agent_type_idx').on(
      table.userId,
      table.agentType
    ),
  })
...
export const uploads = pgTable(
  ...
  table => ({
    ...
    userIdProcessedIdx: index('uploads_user_id_processed_idx').on(
      table.userId,
      table.processed
    ),
  })
...
export const generatedContent = pgTable(
  ...
  table => ({
    ...
    userIdTypeIdx: index('generated_content_user_id_type_idx').on(
      table.userId,
      table.type
    ),
    typeModelIdx: index('generated_content_type_model_idx').on(
      table.type,
      table.model
    ),
  })
...
export const mediaJobs = pgTable(
  ...
  table => ({
    ...
    statusProviderIdx: index('media_jobs_status_provider_idx').on(
      table.status,
      table.provider
    ),
...
export const ingredients = pgTable(
  ...
  table => ({
    ...
    nameCategoryIdx: index('ingredients_name_category_idx').on(
      table.name,
      table.category
    ),
  })
...
export const recipes = pgTable(
  ...
  table => ({
    ...
    nameCategoryIdx: index('recipes_name_category_idx').on(
      table.name,
      table.category
    ),
    categoryActiveIdx: index('recipes_category_active_idx').on(
      table.category,
      table.isActive
    ),
  })
...
export const invoices = pgTable(
  ...
  table => ({
    ...
    supplierStatusIdx: index('invoices_supplier_status_idx').on(
      table.supplier,
      table.status
    ),
    dateStatusIdx: index('invoices_date_status_idx').on(
      table.date,
      table.status
    ),
  })
...
export const agentSettings = pgTable(
  ...
  table => ({
    ...
    userAgentIdx: index('agent_settings_user_agent_idx').on(
      table.userId,
      table.agentType
    ),
